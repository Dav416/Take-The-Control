<template>
  ...
  <aside id="default-sidebar" class="fixed z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[var(--color-tc-blue-green)]">
      <ul class="space-y-2 font-medium">
        ...
        <!-- <li>
          <a href="#" class="">
            <img src="@/assets/images/ligth_take_the_control.png" class="h-18" alt="Take The Control Logo" />
          </a>
        </li> -->
        <li>
